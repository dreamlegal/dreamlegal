...
import { useParams } from 'next/navigation';
import Link from 'next/link';
import { useComparisonVoting } from '@/hooks/useComparisonVoting';

// ComparisonVoteButtons Component
const ComparisonVoteButtons = ({ comparisonSlug }) => {
  const { votes, userVote, isLoading, vote } = useComparisonVoting(comparisonSlug);
...
export default function ComparisonPage() {
  ...
  // Navigation sections - Added voting section
  const sections = [
    { id: 'overview', label: 'Overview' },
    { id: 'features', label: 'Features' },
    { id: 'pricing', label: 'Pricing' },
    { id: 'reviews', label: 'Reviews' },
    { id: 'voting', label: 'Your Opinion' },
    { id: 'sources', label: 'Sources' }
  ];
  ...
  return (
    <div className="min-h-screen pt-16" style={{ backgroundColor: '#f5f7fa' }}>
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-6 sm:py-8">
        ...
        {/* NEW: Voting Section */}
        <section id="voting" className="scroll-mt-32 sm:scroll-mt-44 mb-8 sm:mb-12">
          <h2 className="text-xl sm:text-2xl font-bold mb-4 sm:mb-6" style={{ color: '#1e2556' }}>
            Your Opinion - {productNames}
          </h2>
          
          <div className="bg-white rounded-lg shadow-sm border border-gray-200 p-4 sm:p-6">
            <div className="text-center">
              <h3 className="text-lg font-bold mb-3" style={{ color: '#1e2556' }}>
                Was this comparison helpful?
              </h3>
              <p className="text-sm mb-6" style={{ color: '#334155' }}>
                Let us know if this comparison helped you make a decision
              </p>
              
              <div className="flex justify-center">
                <ComparisonVoteButtons comparisonSlug={slug} />
              </div>
              
              <p className="text-xs mt-4" style={{ color: '#6b7280' }}>
                Your feedback helps us improve our comparisons
              </p>
            </div>
          </div>
        </section>
