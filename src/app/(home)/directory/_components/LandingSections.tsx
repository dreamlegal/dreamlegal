...
const ZohoFormSection = () => {
  ...
  const initializeZohoForm = () => {
    console.log('🔄 Attempting to initialize Zoho form...');
    
    if (typeof window !== 'undefined') {
      const setupSF = (window as any).setupSF;
      
      if (setupSF && !formLoadedRef.current) {
        console.log('✅ setupSF function found, initializing...');
        try {
          setupSF(
            'sf3z0973e9114f522debe7d74678971496bb869f213d7b5dc6f34eeb1578bb316497',
            'ZCFORMVIEW',
            false,
            'light',
            false,
          ...
          console.log('✅ Zoho form initialized successfully!');
        } catch (error) {
          console.error('❌ Error initializing Zoho form:', error);
        }
      } else if (!setupSF) {
        console.log('⏳ setupSF not available yet, will retry...');
      } else {
        console.log('ℹ️ Form already initialized');
      }
    }
  };
  ...
  useEffect(() => {
    ...
    // Also add button click listener for debugging
        ...
        <div className="max-w-6xl mx-auto px-4">
          <div className="bg-white rounded-2xl shadow-lg p-6 md:p-12">
            ...
            <div className="text-center mb-8">
              <h2 className="text-2xl md:text-3xl lg:text-4xl font-bold text-[#1e2556] mb-4">
                Join 3000+ Legal Professionals
              </h2>
              <p className="text-base md:text-lg text-[#334155]">
                Get the latest insights on technology and AI for legal teams
              </p>
            </div>
            ...
            <div className="max-w-2xl mx-auto">
              <div 
                id="sf3z0973e9114f522debe7d74678971496bb869f213d7b5dc6f34eeb1578bb316497" 
                  ...
                  >
                    <div>
                      <span 
                        ...
                        id="SIGNUP_HEADING"
                      >
                        3000 legal professionals are making informed decisions on technology and AI through DreamLegal
                      </span>
                      ...
                      >
                        ...
                        <input type="hidden" id="zc_formIx" name="zc_formIx" value="3z0973e9114f522debe7d74678971496bb869f213d7b5dc6f34eeb1578bb316497" />
