...
//     animate={{ opacity: 1, y: 0 }}
//     transition={{ duration: 0.3 }}
//     className={`${cardBgClass} rounded-lg border ${borderClass} flex flex-col shadow-sm hover:shadow-md transition-all duration-300 h-full cursor-pointer relative group ${isPremium ? 'ring-1 ring-amber-200' : ''}`}
//     onClick={handleClick}
//   >
...
//       <div className="flex items-center justify-center mb-4 h-16">
//         {product.logoUrl ? (
//           <div className={`rounded-lg overflow-hidden ${isPremium ? 'ring-2 ring-amber-300' : ''} bg-white p-2`}>
//             <img 
//               src={product.logoUrl} 
//               alt={`${product.productName} logo`} 
...
//           </div>
//         ) : (
//           <div className={`w-12 h-12 ${isPremium ? 'bg-amber-100 ring-2 ring-amber-300' : 'bg-[#1e2556]/10'} rounded-full flex items-center justify-center`}>
//             <span className={`${isPremium ? 'text-amber-700' : 'text-[#1e2556]'} font-semibold text-lg`}>
//               {product.productName.charAt(0)}
//             </span>
//           </div>
//         )}
