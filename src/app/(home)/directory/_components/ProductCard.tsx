...
//       hover:shadow-xl ${className} ${isPremium ? 'ring-2 ring-amber-200' : ''}`}>
//       {isCompared && (
//         <div className="absolute -top-2 -right-2 bg-[#1e2556] text-white px-3 py-1 
//                 rounded-full text-xs font-medium shadow-lg z-10">
//           Selected for Comparison
...
//             <div className="flex items-start gap-3 sm:gap-4 flex-1 min-w-0">
//               <div className="relative shrink-0">
//                 <div className={`w-14 h-14 sm:w-16 sm:h-16 rounded-xl overflow-hidden shadow-sm bg-white ${isPremium ? 'ring-2 ring-amber-300' : ''}`}>
//                   <img
//                     src={product.logoUrl || '/api/placeholder/64/64'}
//                     alt={product.productName}
//                     className="w-full h-full object-contain p-2"
...
//                   {/* {isPremium && product.tag && (
//                     <span className="inline-flex items-center px-2 sm:px-3 py-1 rounded-full 
//                                    text-xs font-medium bg-gradient-to-r from-amber-100 to-yellow-100 text-amber-800 border border-amber-300">
//                       {product.tag}
//                     </span>
//                   )} */}
//                 </div>
