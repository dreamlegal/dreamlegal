...
//     const element = document.getElementById(sectionId);
//     if (element) {
//       const offset = isMobile ? 180 : 100; // Increased offset for mobile sticky nav
//       const elementPosition = element.offsetTop - offset;
//       window.scrollTo({
//         top: elementPosition,
//         behavior: 'smooth'
...
//           {/* Content Sections with proper spacing */}
//           <div className={`p-4 md:p-6 max-w-6xl ${isMobile ? 'pt-0' : ''}`}>
//             {/* Mobile Info Box */}
//             {isMobile && (
...
//             {/* Section 1: Overview */}
//             <section id="overview" className={`mb-8 ${isMobile ? 'scroll-mt-32' : 'scroll-mt-24'}`}>
//               <h2 className="text-xl font-bold mb-4" style={{ color: '#1e2556' }}>{displaySoftware.productName} Overview</h2>
...
//             {/* Section 2: Features and Functionalities */}
//             <section id="features" className={`mb-8 ${isMobile ? 'scroll-mt-32' : 'scroll-mt-24'}`}>
//               <h2 className="text-xl font-bold mb-4" style={{ color: '#1e2556' }}>{displaySoftware.productName} Features & Functionalities</h2>
...
//             {/* Section 3: Pricing Plans */}
//             <section id="pricing" className={`mb-8 ${isMobile ? 'scroll-mt-32' : 'scroll-mt-24'}`}>
//               <h2 className="text-xl font-bold mb-4" style={{ color: '#1e2556' }}>{displaySoftware.productName} Pricing Plans</h2>
...
//             {/* Section 4: Reviews */}
//             <section id="reviews" className={`mb-8 ${isMobile ? 'scroll-mt-32' : 'scroll-mt-24'}`}>
//               <h2 className="text-xl font-bold mb-4" style={{ color: '#1e2556' }}>{displaySoftware.productName} Reviews</h2>
...
//             {/* Section 5: Images and Videos */}
//             {allMedia.length > 0 && (
//   <section id="media" className={`mb-8 ${isMobile ? 'scroll-mt-32' : 'scroll-mt-24'}`}>
//   <h2 className="text-xl font-bold mb-4" style={{ color: '#1e2556' }}>
//     {displaySoftware.productName} Media
//   </h2>
