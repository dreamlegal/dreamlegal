...
//     try {
//       const uploadPromises = files.map(file => uploadMedia(file, type));
...
//         handleInputChange('videos', [...(formData.videos || []), ...urls]);
//       }
//     } catch (error) {
...
//                           </svg>
//                           <span className="text-sm text-gray-600">
//                             {isUploadingMedia ? 'Uploading...' : 'Click to upload videos'}
//                           </span>
//                           <span className="text-xs text-gray-500 mt-1">MP4, WebM, MOV up to 100MB each</span>
//                         </label>
//                       </div>
