...
import { ChevronDown, ChevronUp, Upload, Save, Image, X } from 'lucide-react';
...
const parseJSON = async () => {
  try {
    ...
    // Get social media data and convert array to string if needed
    const socialMediaData = parsed.section1_product_overview?.contact_information?.social_media;
    const socialMediaString = Array.isArray(socialMediaData) 
      ? socialMediaData.join(', ')  // Convert array to comma-separated string
      : socialMediaData || '';      // Use as-is if already string or empty
  ...
  : [],
      ...
      socialMedia: socialMediaString, // ✅ FIXED: Now handles both array and string
