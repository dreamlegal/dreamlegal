...
// // app/api/companies/analyzed/route.ts (Get all analyzed companies with Product matching)
...
//     console.log(`📊 Fetching analyzed companies with product matching...`);
...
//     // Match analyses with products
//     const enrichedAnalyses = analyses.map(analysis => {
//       // Try to find matching product by company name (case-insensitive)
//       const matchingProduct = products.find(product => 
//         product.CompanyName?.toLowerCase().trim() === analysis.companyName.toLowerCase().trim() ||
//         product.name?.toLowerCase().trim() === analysis.companyName.toLowerCase().trim()
//       );
...
export async function GET(request: NextRequest) {
  try {
    ...
    console.log(`📊 Fetching analyzed companies with flexible product matching...`);
