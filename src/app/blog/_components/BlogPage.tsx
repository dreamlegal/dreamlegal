...
//   }
// `;
// Enhanced blog styles with better mobile responsiveness
// const blogStyles = `
//   .blog-content {
//     font-family: 'Inter', -apple-system, BlinkMacSystemFont, 'Segoe UI', Roboto, sans-serif;
//     color: #2d2d2d;
...
//   /* Inline Product Widget - Responsive */
//   .blog-content .product-widget-inline {
//     display: inline-flex;
//     align-items: center;
...
//     font-weight: 700;
//     color: #1e2556;
//     margin: 0 0 clamp(0.0625rem, 0.25vw, 0.125rem) 0;
//     line-height: 1.3;
//     white-space: nowrap;
//     overflow: hidden;
//     text-overflow: ellipsis;
...
//     .blog-content table {
//       font-size: 0.8rem;
//       margin: 1rem -0.5rem; /* Extend to edges on mobile */
//     }
...
// @media (max-width: 767px) {
//   /* Default: Horizontal scroll for all tables */
//   .blog-content table {
//     display: block;
//     overflow-x: auto;
//     white-space: nowrap;
...
//   /* Handle images in table cells - make them smaller */
...
//   /* Card layout - only when table has class 'table-cards' */
//   .blog-content table.table-cards {
//     display: block;
//     border: none;
//     background: none;
//     overflow-x: visible;
...
//   .blog-content table.table-cards::after {
//     display: none;
//   }
  
//   .blog-content table.table-cards thead {
//     display: none;
//   }
  
//   .blog-content table.table-cards tbody {
//     display: block;
//   }
  
//   .blog-content table.table-cards tr {
//     display: block;
//     margin-bottom: 1rem;
//     padding: 1rem;
//     background-color: #f5f7fa;
...
//   .blog-content table.table-cards tr:nth-child(even) {
//     background-color: #ffffff;
//   }
  
//   .blog-content table.table-cards td {
//     display: block;
//     width: 100% !important;
//     border: none;
...
//   .blog-content table.table-cards td:last-child {
//     border-bottom: none;
//   }
  
//   .blog-content table.table-cards td:before {
...
//   .blog-content table.table-cards td:nth-child(1):before {
//     content: attr(data-label, "Column 1") ": ";
//   }
  
//   .blog-content table.table-cards td:nth-child(2):before {
//     content: attr(data-label, "Column 2") ": ";
//   }
  
//   /* Images in card layout - larger but controlled */
//   .blog-content table.table-cards td img {
//     max-width: 200px;
//     max-height: 150px;
//     margin: 0.5rem auto;
//     display: block;
...
// /* Mobile table handling */
// @media (max-width: 767px) {
//   /* Default: Horizontal scroll for comparison tables (3+ columns) */
//   .blog-content table {
//     display: block;
//     overflow-x: auto;
//     white-space: nowrap;
...
//   /* Card layout only for tables with 2 columns or tables with .table-card class */
//   .blog-content table.table-card,
//   .blog-content table:not([class*="table-"]):has(tr > td:nth-child(2):not(:nth-child(3))) {
//     display: block;
//     border: none;
//     background: none;
//     overflow-x: visible;
...
//   .blog-content table.table-card::after,
//   .blog-content table:not([class*="table-"]):has(tr > td:nth-child(2):not(:nth-child(3)))::after {
//     display: none;
//   }
  
//   .blog-content table.table-card thead,
//   .blog-content table:not([class*="table-"]):has(tr > td:nth-child(2):not(:nth-child(3))) thead {
//     display: none;
//   }
  
//   .blog-content table.table-card tbody,
//   .blog-content table:not([class*="table-"]):has(tr > td:nth-child(2):not(:nth-child(3))) tbody {
//     display: block;
//   }
  
//   .blog-content table.table-card tr,
//   .blog-content table:not([class*="table-"]):has(tr > td:nth-child(2):not(:nth-child(3))) tr {
//     display: block;
//     margin-bottom: 1rem;
//     padding: 1rem;
//     background-color: #f5f7fa;
...
//   .blog-content table.table-card tr:nth-child(even),
//   .blog-content table:not([class*="table-"]):has(tr > td:nth-child(2):not(:nth-child(3))) tr:nth-child(even) {
//     background-color: #ffffff;
//   }
  
//   .blog-content table.table-card td,
//   .blog-content table:not([class*="table-"]):has(tr > td:nth-child(2):not(:nth-child(3))) td {
//     display: block;
//     width: 100% !important;
//     border: none;
//     border-bottom: 1px solid #e2e8f0;
...
//   .blog-content table.table-card td:last-child,
//   .blog-content table:not([class*="table-"]):has(tr > td:nth-child(2):not(:nth-child(3))) td:last-child {
//     border-bottom: none;
//   }
  
//   /* Add data labels for card layout */
//   .blog-content table.table-card td:before,
//   .blog-content table:not([class*="table-"]):has(tr > td:nth-child(2):not(:nth-child(3))) td:before {
//     content: attr(data-label) ": ";
//     font-weight: bold;
//     color: #1e2556;
//     display: block;
...
//   .blog-content table.table-card td:nth-child(1):before,
//   .blog-content table:not([class*="table-"]):has(tr > td:nth-child(2):not(:nth-child(3))) td:nth-child(1):before {
//     content: attr(data-label, "Column 1") ": ";
//   }
  
//   .blog-content table.table-card td:nth-child(2):before,
//   .blog-content table:not([class*="table-"]):has(tr > td:nth-child(2):not(:nth-child(3))) td:nth-child(2):before {
//     content: attr(data-label, "Column 2") ": ";
//   }
  
//   /* Handle images in table cells - limit size and make responsive */
//   .blog-content table td img {
//     max-width: 100%;
//     max-height: 200px;
//     width: auto;
...
//   /* For card layout, make images even smaller */
//   .blog-content table.table-card td img,
//   .blog-content table:not([class*="table-"]):has(tr > td:nth-child(2):not(:nth-child(3))) td img {
//     max-height: 150px;
//     max-width: 200px;
//     margin: 0.5rem auto;
//   }
...
//   /* Handle very wide content on desktop */
//   .blog-content table td {
//     max-width: 300px;
//     overflow-wrap: break-word;
//     word-wrap: break-word;
...
export default function BlogPage() {
  ...
  useEffect(() => {
    const updateScrollProgress = () => {
      try {
        ...
        const contentStart = contentTop - windowHeight * 0.3; // Start tracking when content is 30% visible
        const contentEnd = contentTop + contentHeight - windowHeight * 0.7; // End when 70% through content
        
        if (scrollTop < contentStart) {
          // Haven't reached the main content yet
          setScrollProgress(0);
        } else if (scrollTop > contentEnd) {
          // Finished reading the main content
          setScrollProgress(100);
        } else {
          // Currently reading the main content
        ...
        console.log('Blog Content Progress:', {
          scrollTop,
          contentTop,
          contentHeight,
          progress: Math.min(Math.max(((scrollTop - contentStart) / (contentEnd - contentStart)) * 100, 0), 100)
        });
    ...
    // Initial calculation with a slight delay to ensure refs are ready
  ...
  }, [blog]); // Include blog dependency to recalculate when content loads
  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-blue-50/50 to-white">
      ...
      {/* ENHANCED PROGRESS BAR - Tracks main article content only */}
      <div className="fixed top-0 left-0 w-full h-2 bg-gray-200 z-[9999] shadow-sm">
        ...
        {/* Progress percentage indicator (optional - you can remove this) */}
        {scrollProgress > 0 && (
          <div 
