...
//   /* NEW: Contributor Widget Styling - Responsive */
//   .blog-content .contributor-widget-compact {
...
//   .blog-content .contributor-widget-compact:hover {
//     border-color: #1e2556;
//     background-color: #ffffff;
//     box-shadow: 0 2px 8px rgba(30, 37, 86, 0.1);
//   }

//   .blog-content .contributor-widget-header {
//     display: flex;
//     align-items: center;
//     gap: clamp(0.25rem, 0.75vw, 0.375rem);
//     margin-bottom: clamp(0.25rem, 0.75vw, 0.375rem);
//   }

//   .blog-content .contributor-widget-header svg {
//     color: #1e2556;
//     flex-shrink: 0;
...
//   .blog-content .contributor-widget-header span {
//     font-size: clamp(0.65rem, 2vw, 0.75rem);
//     font-weight: 600;
//     color: #1e2556;
//   }

//   .blog-content .contributor-widget-list {
//     display: flex;
//     flex-wrap: wrap;
//     gap: clamp(0.1875rem, 0.5vw, 0.25rem);
//   }

//   .blog-content .contributor-card-compact {
//     display: inline-flex;
//     align-items: center;
//     gap: clamp(0.1875rem, 0.5vw, 0.25rem);
//     padding: clamp(0.1875rem, 0.5vw, 0.25rem) clamp(0.25rem, 0.75vw, 0.375rem);
//     background-color: white;
...
//   .blog-content .contributor-card-compact:hover {
//     border-color: #1e2556;
//     box-shadow: 0 1px 4px rgba(30, 37, 86, 0.15);
//   }

//   .blog-content .contributor-avatar-compact {
//     width: clamp(0.75rem, 2vw, 1rem);
//     height: clamp(0.75rem, 2vw, 1rem);
//     object-fit: cover;
//     border-radius: 50%;
...
//   .blog-content .contributor-name-compact {
//     font-size: clamp(0.625rem, 1.75vw, 0.7rem);
//     font-weight: 500;
//     color: #1e2556;
//     white-space: nowrap;
//     overflow: hidden;
...
//   .blog-content .contributor-widget-empty {
//     display: none;
//   }
...
//     /* Mobile contributor widget adjustments */
//     .blog-content .contributor-widget-list {
...
//                   {/* DYNAMIC BANNER - YouTube Video for Legal Tech Academy, Image for others */}
//                   {blog.bannerImage && (
//                     <div className="w-full overflow-hidden rounded-lg md:rounded-xl md:shadow-md">
//                       {isLegalTechAcademy(blog.category) ? (
//                         /* YouTube Video Embed for Legal Tech Academy */
//                         (() => {
...
//                             </div>
//                           ) : (
//                             /* Fallback to image if not a valid YouTube URL */
//                             <div className="w-full aspect-[16/9]">
//                               <img
