...
//     };
//   }, []); // Remove blog dependency to ensure it always runs
...
//       {/* ENHANCED PROGRESS BAR - More visible and always on top */}
//       <div className="fixed top-0 left-0 w-full h-2 bg-gray-200 z-[9999] shadow-sm">
//         <div 
//           className="h-full bg-gradient-to-r from-blue-500 via-blue-600 to-blue-700 transition-all duration-200 ease-out shadow-sm"
//           style={{ 
...
//         {scrollProgress > 0 && (
//           <div 
//             className="absolute top-0 right-2 text-xs text-blue-600 font-medium bg-white px-2 py-1 rounded-b-md shadow-sm"
//             style={{ fontSize: '10px' }}
//           >
