...
// Separate BookmarkCard into its own component with dynamic import
const BookmarkCard = dynamic(() => Promise.resolve(({ product, onDelete }) => {
  const [isHovered, setIsHovered] = useState(false);
        ...
        {loading ? (
          ...
          <Card className="border-dashed border-2">
            <CardContent className="p-12 text-center">
              ...
              <Link href="/products" className="inline-flex items-center justify-center px-4 py-2 rounded-lg bg-gradient-to-r from-indigo-500 to-purple-500 text-white font-medium shadow-lg hover:shadow-xl transition-all duration-300 hover:-translate-y-0.5">
                Explore Products
              </Link>
            </CardContent>
          </Card>
