...
// // //       <div className="absolute top-20 right-20 w-96 h-96 bg-[#7cc6ee]/10 rounded-full blur-3xl" />
// // //       <div className="absolute bottom-20 left-20 w-80 h-80 bg-[#1e2556]/10 rounded-full blur-3xl" />
...
// // //         {/* Compact Blue Strip */}
// // //         <div className="mb-16">
// // //           <div className="bg-[#7cc6ee] rounded-2xl shadow-lg max-w-5xl mx-auto">
...
// // //                   <div className="p-3 ">
// // //                     <Star className="w-8 h-8 text-[#1e2556]" />
// // //                   </div>
// // //                   <div>
// // //                     <div className="text-xl font-bold text-white">Strong</div>
// // //                     <div className="text-white/90 font-medium">reputation</div>
// // //                   </div>
// // //                 </div>
...
// // //                 <div className="flex items-center gap-3">
// // //                   <div className="p-3 ">
// // //                     <Users className="w-8 h-8 text-[#1e2556]" />
// // //                   </div>
// // //                   <div>
// // //                     <div className="text-xl font-bold text-white">High intent</div>
// // //                     <div className="text-white/90 font-medium">deals</div>
// // //                   </div>
// // //                 </div>
...
// // //                 <div className="flex items-center gap-3">
// // //                   <div className="p-3 ">
// // //                     <Headphones className="w-8 h-8 text-[#1e2556]" />
// // //                   </div>
// // //                   <div>
// // //                     <div className="text-xl font-bold text-white">Deep market</div>
// // //                     <div className="text-white/90 font-medium">understanding</div>
// // //                   </div>
// // //                 </div>
// // //               </div>
// // //             </div>
...
// // //           <div className="bg-white/70 backdrop-blur-sm rounded-3xl shadow-2xl border border-[#7cc6ee]/20 p-10 lg:p-12 relative overflow-hidden">
       
// // //             <div className="absolute top-0 right-0 w-64 h-64 bg-gradient-to-bl from-[#7cc6ee]/10 to-transparent rounded-full blur-2xl" />
// // //             <div className="absolute bottom-0 left-0 w-48 h-48 bg-gradient-to-tr from-[#1e2556]/10 to-transparent rounded-full blur-2xl" />
            
// // //             <div className="grid lg:grid-cols-2 gap-12 items-center relative z-10">
              
// // //               <div className="flex justify-center lg:justify-start">
// // //                 <div className="relative group">
// // //                   <div className="absolute -inset-4 bg-gradient-to-r from-[#7cc6ee] to-[#1e2556] rounded-full blur opacity-75 group-hover:opacity-100 transition duration-500 animate-pulse" />
// // //                   <div className="relative w-40 h-40 rounded-full overflow-hidden shadow-2xl border-4 border-white">
...
// // //                       <span className="text-white text-5xl font-bold">IH</span>
// // //                     </div>
// // //                   </div>
                
// // //                   <div className="absolute -top-2 -right-2 w-6 h-6 bg-[#7cc6ee] rounded-full animate-bounce delay-100" />
// // //                   <div className="absolute -bottom-3 -left-3 w-4 h-4 bg-[#1e2556] rounded-full animate-bounce delay-300" />
// // //                 </div>
// // //               </div>
...
// // //               <div>
// // //                 <div className="mb-8">
// // //                   <div className="text-6xl text-[#7cc6ee]/30 font-serif leading-none mb-4">"</div>
// // //                   <blockquote className="text-2xl lg:text-3xl font-bold leading-tight text-[#1e2556] relative">
...
// // //                 <div className="mb-8">
// // //                   <h4 className="text-2xl font-bold mb-2 text-[#1e2556]">
// // //                     Ilan Hertz
// // //                   </h4>
// // //                   <p className="text-lg mb-4 text-[#334155]">
// // //                     VP of Marketing at Gaviti
// // //                   </p>
                  
// // //            <div className="font-bold text-xl mb-6 text-[#1e2556] tracking-wider">
// // //                     GAVITI
// // //                   </div>
// // //                 </div>
...
// // //                 <a 
// // //                   href="#" 
// // //                   className="group inline-flex items-center gap-3 px-6 py-3 rounded-xl bg-gradient-to-r from-[#7cc6ee]/10 to-[#1e2556]/10 hover:from-[#7cc6ee]/20 hover:to-[#1e2556]/20 border border-[#7cc6ee]/20 hover:border-[#7cc6ee]/40 text-[#7cc6ee] font-semibold text-lg transition-all duration-300 hover:shadow-lg hover:scale-105"
// // //                 >
...
// //           <div className="bg-[#7cc6ee] rounded-xl sm:rounded-2xl shadow-lg max-w-full sm:max-w-5xl mx-auto">
// //             <div className="px-4 py-6 sm:px-6 sm:py-8 lg:px-8 lg:py-10">
// //               {/* Compact Heading */}
// //               <div className="text-center mb-6 sm:mb-8">
// //                 <h3 className="text-lg sm:text-2xl lg:text-3xl font-bold text-white leading-tight px-2">
// //                   We are the kingmakers of the legal tech industry
// //                 </h3>
// //               </div>
...
// //                     <Star className="w-6 h-6 sm:w-8 sm:h-8 text-[#1e2556]" />
// //                   </div>
// //                   <div className="text-center sm:text-left">
// //                     <div className="text-lg sm:text-xl font-bold text-white">Strong</div>
// //                     <div className="text-sm sm:text-base text-white/90 font-medium">reputation</div>
// //                   </div>
// //                 </div>

// //                 {/* Separator */}
// //                 <div className="hidden sm:block w-px h-8 sm:h-12 bg-white/30 flex-shrink-0"></div>

// //                 {/* High Intent Deals */}
// //                 <div className="flex items-center gap-2 sm:gap-3 w-full sm:w-auto justify-center sm:justify-start">
// //                   <div className="p-2 sm:p-3 flex-shrink-0">
// //                     <Users className="w-6 h-6 sm:w-8 sm:h-8 text-[#1e2556]" />
// //                   </div>
// //                   <div className="text-center sm:text-left">
// //                     <div className="text-lg sm:text-xl font-bold text-white">High intent</div>
// //                     <div className="text-sm sm:text-base text-white/90 font-medium">deals</div>
// //                   </div>
// //                 </div>
...
// //                 <div className="flex items-center gap-2 sm:gap-3 w-full sm:w-auto justify-center sm:justify-start">
// //                   <div className="p-2 sm:p-3 flex-shrink-0">
// //                     <Headphones className="w-6 h-6 sm:w-8 sm:h-8 text-[#1e2556]" />
// //                   </div>
// //                   <div className="text-center sm:text-left">
// //                     <div className="text-lg sm:text-xl font-bold text-white">Deep market</div>
// //                     <div className="text-sm sm:text-base text-white/90 font-medium">understanding</div>
// //                   </div>
// //                 </div>
// //               </div>
// //             </div>
