...
// //       {/* Section 1 - White Background: Image Left, Text Right */}
// //       <section className="py-20 px-6 sm:px-8 lg:px-12" style={{ backgroundColor: '#f5f7fa' }}>
// //         <div className="max-w-7xl mx-auto">
// //           <div className="grid lg:grid-cols-2 gap-12 items-center">
// //             {/* Left - Image */}
// //             <div className="relative">
// //               <div className="bg-white rounded-lg shadow-2xl ">
// //                 <img src="https://images.unsplash.com/photo-1600880292203-757bb62b4baf?ixlib=rb-4.0.3&ixid=M3wxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8fA%3D%3D&auto=format&fit=crop&w=2070&q=80" alt="Software Image" className="w-full aspect-[16/9] rounded-lg mb-6" />
...
// //               <h2 className="text-4xl sm:text-5xl font-bold mb-6" style={{ color: '#1e2556' }}>
// //                 Build product profiles that bring trust
// //               </h2>
// //               <p className="text-xl leading-relaxed mb-8" style={{ color: '#334155' }}>
...
// //               </p>
// //               <button className="inline-flex items-center px-6 py-3 text-base font-semibold text-white rounded-full transition-all duration-300 hover:opacity-90 hover:scale-105 border-4 border-black" style={{ backgroundColor: '#1e2556' }}>
...
// //       <section className="py-20 px-6 sm:px-8 lg:px-12 text-white" style={{ backgroundColor: '#1e2556' }}>
// //         <div className="max-w-7xl mx-auto">
// //           <div className="grid lg:grid-cols-2 gap-12 items-center">
// //             {/* Left - Text */}
// //             <div>
// //               <h2 className="text-4xl sm:text-5xl font-bold mb-6">
// //                 Capture active RFPs and leads
// //               </h2>
// //               <p className="text-xl leading-relaxed mb-8 text-white/90">
// //                 Get in front of active RFPs from law firms and legal departments looking for solutions. Share your proposals and product offerings to high-intent legal teams. No cold outreach — just real, high-intent opportunities.
// //               </p>
...
// //                 <br />
// //                 <a href="/auth/vendor/signup" className="inline-flex items-center text-lg font-medium hover:underline transition-all duration-300" style={{ color: '#7cc6ee' }}>
...
// //             {/* Right - Image */}
// //             <div className="relative">
// //               <div className="aspect-[16/9] bg-cover bg-center bg-no-repeat rounded-lg shadow-2xl" style={{ backgroundImage: 'url("https://images.unsplash.com/photo-1600880292203-757bb62b4baf?ixlib=rb-4.0.3&ixid=M3wxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8fA%3D%3D&auto=format&fit=crop&w=2070&q=80")' }}>
// //               </div>
// //             </div>
// //           </div>
// //         </div>
...
// //       {/* Section 3 - White Background: Image Left, Text Right */}
// //       <section className="py-20 px-6 sm:px-8 lg:px-12" style={{ backgroundColor: '#f5f7fa' }}>
// //         <div className="max-w-7xl mx-auto">
// //           <div className="grid lg:grid-cols-2 gap-12 items-center">
// //             {/* Left - Image */}
// //             <div className="relative">
// //               <div className="bg-white rounded-lg shadow-2xl ">
// //                 <div className="aspect-[16/9] bg-cover bg-center bg-no-repeat rounded-lg" style={{ backgroundImage: 'url("https://images.unsplash.com/photo-1600880292203-757bb62b4baf?ixlib=rb-4.0.3&ixid=M3wxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8fA%3D%3D&auto=format&fit=crop&w=2070&q=80")' }}>
// //                 </div>
// //               </div>
// //             </div>
...
// //               <button className="inline-flex items-center px-6 py-3 text-base font-semibold bg-white rounded-full transition-all duration-300 hover:opacity-90 hover:scale-105 border-4 border-black" style={{ color: '#1e2556' }}>
// //                 Book a demo
// //               </button>
// //             </div>
// //           </div>
