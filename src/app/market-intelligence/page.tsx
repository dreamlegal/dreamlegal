...
// // const SubPanelDetail = ({ subPanelData, onBack, sidebarOpen, setSidebarOpen }) => {
...
// //           <button 
// //             onClick={onBack}
// //             className="mb-6 flex items-center hover:opacity-80 transition-opacity w-full"
// //             style={{ color: '#7cc6ee' }}
// //           >
...
// //             Panel details are displayed on the right. Use the sidebar toggle to hide/show this panel.
// //           </div>
// //         </div>
// //       </div>
...
// async function fetchMarketIntelligence() {
//   try {
//     console.log('🌐 Frontend: Fetching market intelligence data...');
...
//     console.log('🔍 Frontend: Extracted insights:', insights);
    
//     return insights;
//   } catch (error) {
//     console.error('❌ Frontend: Error fetching market intelligence:', error);
