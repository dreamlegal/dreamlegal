...
//   return (
//     <div className="h-screen bg-gray-50 pt-16 flex flex-col"> {/* Added pt-16 for navbar space */}
//       {/* Progress Bar */}
...
//         <div className="bg-white flex-1 flex flex-col rounded-lg shadow-sm">
...
//                   <div className="mt-4">
//                     <label className="block text-xs text-[#334155] mb-2">Current Allocated Budget (Optional)</label>
...
//                         onChange={(e) => updateFormData('budgetCurrent', e.target.value)}
//                         placeholder="50,000"
//                         className="w-full pl-8 pr-3 py-3 border border-gray-300 rounded-lg focus:ring-2 focus:ring-[#7cc6ee] focus:border-transparent"
//                       />
//                     </div>
