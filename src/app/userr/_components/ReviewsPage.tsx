...
//             {/* Product Logo */}
//             <div className="flex-shrink-0">
//               <div className="relative w-12 h-12 rounded-lg overflow-hidden bg-gradient-to-br from-emerald-50 to-teal-50 shadow-sm">
//                 {review.product?.logoUrl ? (
//                   <img
//                     src={review.product.logoUrl}
//                     alt={review.product.name}
...
//                 <span className="inline-flex items-center px-2.5 py-0.5 rounded-full text-xs font-medium bg-gradient-to-r from-emerald-50 to-teal-50 text-emerald-800 border border-emerald-100">
...
//               <span>Ease of Learning: {review.easeOfLearning}/5</span>
//             </div>
//             <div className="flex items-center gap-2 text-sm text-gray-600">
//               <ThumbsUp className="w-4 h-4 text-emerald-600" />
//               <span>Integration: {review.integration}/5</span>
//             </div>
//             <div className="flex items-center gap-2 text-sm text-gray-600">
//               <Activity className="w-4 h-4 text-emerald-600" />
//               <span>ROI: {review.roi}/5</span>
//             </div>
//             <div className="flex items-center gap-2 text-sm text-gray-600">
