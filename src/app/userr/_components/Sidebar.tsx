...
// app/user/_components/Sidebar.tsx
// 'use client';
...
//   const ContactButton = ({ icon: Icon, text }: { icon: any; text: string }) => (
//     <button className="flex-1 flex flex-col items-center p-2 rounded-lg hover:bg-white transition-all duration-200 group">
//       <Icon size={16} className="text-gray-600 group-hover:text-gray-900 mb-1" />
//       <span className="text-xs text-gray-600 group-hover:text-gray-900">{text}</span>
//     </button>
//   );

//   const SocialButton = ({ Icon }: { Icon: any }) => (
//     <button className="w-8 h-8 flex items-center justify-center rounded-lg hover:bg-white text-gray-600 hover:text-gray-900 transition-all duration-200">
//       <Icon size={16} />
//     </button>
//   );
...
//               <span className="text-white font-bold text-sm">D</span>
//             </div>
//             <span className="font-semibold text-sm text-gray-900">DreamLegal</span>
//           </div>
...
//                 <h2 className="font-semibold mb-3 text-sm text-gray-900">Contact us</h2>
//                 <div className="flex justify-between items-center">
//                   <ContactButton icon={MessageSquare} text="Chat" />
//                   <ContactButton icon={Mail} text="Email" />
//                   <ContactButton icon={Phone} text="Call" />
//                 </div>
//               </div>
...
//               <button
//                 onClick={() => setIsVendor(!isVendor)}
//                 className="w-full mt-4 px-3 py-2 bg-gray-900 text-white rounded-lg font-medium hover:bg-gray-800 transition-all duration-200 text-sm"
//               >
//                 Logout
//               </button>
//             </motion.div>
...
//       <button
//         onClick={() => setIsVendor(!isVendor)}
//         className="w-full px-3 py-2 bg-gray-900 text-white rounded-lg font-medium hover:bg-gray-800 transition-all duration-200 text-sm"
//       >
//         Logout
//       </button>
//     </div>
