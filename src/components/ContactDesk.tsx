...
function ContactDesk() {
  return (
    <div className="py-8 md:py-16 lg:py-20 bg-[#f5f7fa] relative overflow-hidden">
      {/* Background Elements */}
      ...
      <div className="px-4 mx-auto max-w-7xl relative z-10">
        <div className="max-w-xl mx-auto">
          <div className="flex flex-col mb-8 md:mb-16 text-center animate-fadeIn">
            ...
            <h2 className="mb-4 md:mb-6 text-2xl md:text-3xl lg:text-4xl font-bold leading-tight text-[#1e2556] px-4">
              Contact us directly
            </h2>
          </div>
        </div>
        ...
        <div className="max-w-7xl mx-auto px-0 md:px-4">
          <div className="flex flex-col md:flex-row gap-4 md:gap-8">
            {/* Support Card */}
            <div className="group relative p-0.5 overflow-hidden transition duration-300 transform border rounded-xl md:rounded-2xl hover:border-[#7cc6ee] hover:cursor-pointer shadow-sm hover:scale-[1.02] hover:shadow-xl bg-white md:w-1/3">
              <div className="absolute inset-0 bg-[#f5f7fa] opacity-0 group-hover:opacity-100 transition-opacity duration-300" />
