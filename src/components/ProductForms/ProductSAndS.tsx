...
// Modified Zod Schema with all fields optional
const ProductSAndSSchema = z.object({
...
const ProductSAndS = () => {
  ...
  // Add storage value
  const handleAddStorage = () => {
    // Always set storage regardless of validation
    setStorage(`${inputValue}${selectedUnit.toString()}`);
    setInputValue('');
    setSelectedUnit(units[0]);
  };
  ...
  // Add file size value
  const handleAddFileSize = () => {
    // Always set file size regardless of validation
    setFileSize(`${inputFileSize}${selectedFileSizeUnit.toString()}`);
    setInputFileSize('');
    setSelectedFileSizeUnit(units[0]);
  };
