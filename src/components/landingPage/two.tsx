                  ...
                  {searchMode === 'directory' ? (
                    ...
                    <>
                      ...
                      <button 
                        onClick={(e) => handleSearch(e)}
                        className="px-6 py-3 bg-[#1e2556] text-white rounded-xl hover:bg-[#1e2556]/90
                                 transition-colors duration-200 flex items-center gap-2 font-semibold whitespace-nowrap"
                      >
                        <Search className="w-5 h-5" />
                        Search
                      </button>
                    ...
                    <>
                      <select
                        ...
                        className="w-full px-4 py-3 text-base border-0 focus:ring-0 focus:outline-none bg-white text-[#2d2d2d] rounded-l-xl cursor-pointer"
                      >
                      ...
                      <button 
                        ...
                        className={`px-6 py-3 text-white rounded-xl transition-all duration-200 flex items-center gap-2 font-semibold whitespace-nowrap ${
                          selectedCategory
