...
//   return (
//     <div ref={sectionRef} className="w-full  py-12 relative">
//       {/* Premium Background */}


//       <div className="max-w-5xl mx-auto px-4 relative">
//         <div className={`bg-white/90 rounded-2xl shadow-lg border border-gray-100/50 overflow-hidden backdrop-blur-sm
//                       transform transition-all duration-700 ${isInView ? 'opacity-100 translate-y-0' : 'opacity-0 translate-y-10'}`}>
          
//           <div className="grid md:grid-cols-2">
//             {/* Left Content Side */}
//             <div className="relative p-8 bg-gradient-to-br from-blue-50/50 to-indigo-50/50">
//               <div className="space-y-6">
//                 <div className="inline-flex items-center gap-2 px-4 py-2 rounded-full bg-gradient-to-r from-blue-100/50 to-indigo-100/50 border border-blue-200/50 shadow-sm">
//                   <Sparkles className="w-4 h-4 text-blue-600" />
//                   <span className="text-sm font-semibold text-blue-600 tracking-wide">GET STARTED</span>
//                 </div>
...
//                       className="group relative w-full inline-flex items-center gap-3 px-6 py-4 rounded-xl
...
//                         <span className="block text-lg font-semibold text-white mb-0.5">Choose Your Category</span>
//                         <span className="text-sm text-white/70">Click to explore options</span>
//                       </div>
...
//                         <ArrowRight className="absolute inset-0 w-full h-full p-1.5 text-blue-600" />
//                       </div>
//                     </div> */}
//                   </div>
//                 )}
...
//               <div className="absolute bottom-0 right-0 w-24 h-24 bg-gradient-to-br from-blue-100/20 to-indigo-100/20 rounded-tl-3xl" />
//             </div>
...
//                     >
//                       <div className={`group w-full inline-flex items-center gap-3 px-6 py-4 rounded-xl
...
//                           {option.title}
//                         </span>
//                         {/* <ChevronRight className="w-5 h-5 text-white opacity-75" /> */}
//                         <div className="flex items-center justify-center w-10 h-10 rounded-lg bg-white/20">
//                         <MousePointerClick className="w-5 h-5 text-white" />
//                       </div>
//                       </div>
...
//                     className="absolute -bottom-2 left-6 text-xs text-blue-600 bg-white px-2"
//                   >
//                     Work email address
//                   </motion.div>
//                 )}
