...
// import { ArrowUpRight, Plus, Minus, Circle, ArrowDown, Code2, Rocket, Terminal, ExternalLink, Github, Linkedin } from 'lucide-react';
...
//       <div 
//         ref={cursorRef}
//         className={`fixed w-8 h-8 rounded-full pointer-events-none z-50 mix-blend-difference transition-transform duration-150 ease-out ${
...
//             <div className="text-sm tracking-widest relative overflow-hidden group">
...
//                 <button 
//                   key={item}
//                   className="text-sm tracking-widest hover:opacity-50 transition-opacity relative group"
...
//           <div className="grid grid-cols-12 gap-8">
//             {[
//               { icon: Code2, title: 'Development', desc: 'Creating digital solutions' },
//               { icon: Terminal, title: 'Architecture', desc: 'Building robust systems' },
...
//               {/* Previous code remains the same until the Contact Section's h2 tag */}
...
//               © 2024 Digital Craftsman. All rights reserved.
//             </div>
