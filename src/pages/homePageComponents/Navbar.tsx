...
//   return (
//     <div className="w-full px-4 fixed top-6 left-0 right-0 z-50">
//       <nav className={`
//         max-w-6xl mx-auto 
//         rounded-2xl
//         transition-all duration-300 ease-in-out
...
//         {/* Mobile menu */}
//         <div className={`md:hidden transition-all duration-300 ease-in-out ${
//           isOpen ? 'max-h-[80vh] opacity-100 border-t border-gray-100' : 'max-h-0 opacity-0'
//         } overflow-y-auto`}>
//           <div className="px-6 pt-2 pb-4 space-y-1">
//             {navItems.map((item, index) => (
//               <div key={index} className="space-y-1">
...
//         <div className={`fixed inset-0 bg-black/5 backdrop-blur-sm md:hidden transition-all duration-300 ${
//           isOpen ? 'opacity-100 visible' : 'opacity-0 invisible'
//         }`} onClick={() => setIsOpen(false)}>
//           <div 
//             className={`absolute right-0 top-0 h-full w-11/12 max-w-sm bg-white shadow-2xl transition-transform duration-300 ease-in-out ${
...
//                       className={`w-full flex items-center justify-between p-3 rounded-xl text-base font-medium transition-all duration-200 ${
...
//                         activeDropdown === index ? 'max-h-64 mt-2' : 'max-h-0'
//                       }`}>
...
//                               key={idx}
//                               href="#"
//                               className="block px-4 py-3 text-sm text-gray-600 hover:text-black hover:bg-gray-100 first:rounded-t-xl last:rounded-b-xl transition-colors duration-200"
//                             >
//                               {dropdownItem}
//                             </a>
//                           ))}
...
//                 <button className="w-full px-4 py-3 text-base font-medium bg-gray-50 text-gray-600 hover:text-black hover:bg-gray-100 rounded-xl transition-colors duration-200">
//                   Open app
//                 </button>
//                 <button className="w-full px-4 py-3 text-base font-medium bg-black text-white hover:bg-gray-800 rounded-xl transition-colors duration-200">
//                   Get a demo
//                 </button>
//               </div>
//             </div>
              ...
              <div className="bg-white/80 backdrop-blur-lg shadow-lg rounded-xl overflow-hidden">
                <div className="p-4">
                            ...
                            <div className="pl-4 space-y-1 pt-1">
                              {item.dropdownItems.map((dropdownItem, idx) => (
                                <a
                                  key={idx}
                                  href="#"
                                  className="block p-2 text-sm text-gray-500 hover:text-gray-900 hover:bg-gray-50 rounded-lg transition-colors duration-200"
                                >
                                  {dropdownItem}
                                </a>
                              ))}
                  ...
                  <div className="space-y-2">
                    <button className="w-full p-2 text-sm font-medium text-gray-600 hover:text-gray-900 hover:bg-gray-50 rounded-lg transition-colors duration-200">
                      Open app
                    </button>
                    <button className="w-full p-2 text-sm font-medium bg-black text-white rounded-lg hover:bg-gray-800 transition-colors duration-200">
                      Get a demo
                    </button>
                  </div>
                </div>
